...
class User:
    ...
    def get_user_by_email (cls, email):
      query = """SELECT first_name, last_name, email, password, created_at, updated_at FROM user WHERE email=%(email)s;"""
      results = connectToMySQL('user_recipe').query_db(query, {"email": email})
    ...
    def validate(data):
        ...
        # Check that only letters are entered for first and last name
        ...
        # Check that account with email does not exist
